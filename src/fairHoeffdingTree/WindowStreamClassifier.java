 ...
 * hoeffding trees in the classifier window WONT get updated with instances in the current window
 * 
...
public class WindowStreamClassifier {
	...
	//Store predicted and actual labels over the whole stream
//	private static int []predictedClassLabelArr;
//	private static int []trueClassLabelArr;
//	private static int []saValueArr;
//	private static int indexOfCurrentInst= 0;
	...
	public static void main(String[] args) throws Exception {
		...
		//Store predicted and actual labels over the whole stream
//		predictedClassLabelArr= new int[stream.numInstances()];
//		trueClassLabelArr= new int[stream.numInstances()];
//		saValueArr= new int[stream.numInstances()];
		

		String outputFileName = "fair-"+inputFileName + "_" + windowSizeOfClassifer + ".csv";
		//String outputFileName = "fair-win-noUpdate-labels.csv";
...
//		// finish current window size
//		indexOfCurrentInst= 0;
...
//		}
	...
	protected double[] performanceStatistics(Instances data, int numOfClassifierCounter, HoeffdingTree[] classifierList)
		...
		for (int j = 0; j < windowSize; j++) {
			 ...
			 * update label array
			 */
			//System.out.println("index:"+indexOfCurrentInst);
//			predictedClassLabelArr[indexOfCurrentInst]= predictedClassLabel[j];
//			trueClassLabelArr[indexOfCurrentInst]= actualClassLabel;
//			saValueArr[indexOfCurrentInst]= (int) data.instance(j).value(saIndex);
//			indexOfCurrentInst++;
